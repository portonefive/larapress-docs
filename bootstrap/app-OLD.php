...
// Load the facades.
/*----------------------------------------------------*/
LaraPress\Support\Facades\Facade::clearResolvedInstances();

LaraPress\Support\Facades\Facade::setFacadeApplication($app);
...
add_filter(
    ...
    function ($sizes)
    {
        $sizes['_larapress_media'] = __('LaraPress Media Thumbnail', LARAPRESS_TEXTDOMAIN);
...
/*----------------------------------------------------*/
// LaraPress styles
LaraPress\Support\Facades\Asset::add('larapress-core-styles', 'css/_larapress-core.css')->to('admin');

// LaraPress scripts
LaraPress\Support\Facades\Asset::add(
